...
本次更新带来了全新的学习体验和代码架构优化：

- ✨ **练习模式**：错词本和收藏夹新增专门的练习会话，闪卡式学习体验，"记住了"/"忘记了"快速反馈
- 📊 **增强统计页面**：全新的统计可视化界面，7天学习趋势图表、成就墙展示
- 🧠 **间隔重复算法**：基于 SM-2 算法的智能复习系统，根据记忆质量动态调整复习间隔
- 🎨 **统一主题系统**：ColorTheme 管理所有颜色，深色/浅色模式无缝切换
- 🔧 **视图修饰器库**：统一的卡片样式、悬停动画、流畅的用户体验
- 🔒 **安全性提升**：SQL 注入防护，参数化查询
- ♻️ **代码重构**：模块化设计，代码重复率降低 40%，可维护性大幅提升

下载：[Moyu-2.2.0.dmg](https://github.com/coutureone/Moyu/releases/download/v2.2.0/Moyu-2.2.0.dmg)
...
- 🇯🇵 **日语支持** - 包含五十音、标日中级词汇
- 🎯 **高效记忆** - 记忆模式 + 选择题测试 + 闪卡练习模式 🆕
- ⭐ **收藏夹 & 错词本** - 支持专门的练习会话，智能复习推荐 🆕
- 📈 **统计面板** - 今日/累计对错数、7天趋势图 🆕、成就墙 🆕、学习时长追踪
- 🎚️ **自定义数量** - 闹钟式滚轮选择学习数量
